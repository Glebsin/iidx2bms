...
2. Download [`iidx2bms.zip`](https://github.com/Glebsin/iidx2bms/releases/download/2025.207.0/iidx2bms.zip) from Release
    2.1 Run "setup.bat" if you downloaded zip from "code" tab
